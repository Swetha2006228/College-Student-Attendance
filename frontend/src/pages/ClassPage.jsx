        ...
        <div className='w-1/3 bg-[#121212] p-4 rounded-xl border border-blue-600 shadow-[0_0_25px_rgba(0,102,255,0.3)]'>
          ...
          <div className='flex flex-col gap-3 h-[60vh] overflow-y-auto'>
            {students.map((s) => (
              <div
                key={s._id}
                className='student-row group flex justify-between items-center bg-[#1a1a1a] p-2 rounded-md min-h-[44px]'
              >
                <span>{s.name}</span>
        ...
        <div className='w-2/3 bg-[#121212] p-4 rounded-xl border border-blue-600 shadow-[0_0_25px_rgba(0,102,255,0.3)]'>
          ...
          <div className='flex flex-col gap-3 h-[60vh] overflow-y-auto'>
            {students.map((s) => (
              <div
                key={s._id}
                className='attendance-row flex items-center justify-center gap-4 bg-[#1a1a1a] p-2 rounded-md min-h-[44px]'
              >
                <input
                  type='checkbox'
                  disabled={isPastDate}
                ...
                <span
                  className={`text-sm ${
                    attendance[s._id] ? "text-green-400" : "text-red-400"
                  }`}
                >
